...
public interface PositionalList<E> {
	...
	/**
	 * Inserts element e at the front of the list and returns its new
	 * Position.
	 */
	Position<E> addFirst(E e);

	/**
	 * Inserts element e at the back of the list and returns its new
	 * Position.
	 */
	Position<E> addLast(E e);

	/**
	 * Inserts element e immediately before Position p and returns its
	 * new Position.
	 */
